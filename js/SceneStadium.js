class SceneStadium extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('ball', 'content/ball.png', {
            frameWidth: 60,
            frameHeight: 60
        });

        this.load.spritesheet(player1Key, playerGraphics[0], {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet(player2Key, playerGraphics[1], {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyBrowns", 'content/playerBrowns.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyBengals", 'content/playerBengals.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keySteelers", 'content/playerSteelers.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyRavens", 'content/playerRavens.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyChargers", 'content/playerChargers.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyChiefs", 'content/playerChiefs.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyBroncos", 'content/playerBroncos.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyRaiders", 'content/playerRaiders.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyTitans", 'content/playerTitans.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyColts", 'content/playerColts.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyTexans", 'content/playerTexans.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyJaguars", 'content/playerJaguars.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyPatriots", 'content/playerPatriots.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyBills", 'content/playerBills.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyJets", 'content/playerJets.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyDolphins", 'content/playerDolphins.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyPackers", 'content/playerPackers.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyLions", 'content/playerLions.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyBears", 'content/playerBears.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyVikings", 'content/playerVikings.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyRedskins", 'content/playerRedskins.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyGiants", 'content/playerGiants.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyEagles", 'content/playerEagles.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyCowboys", 'content/playerCowboys.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyBuccaneers", 'content/playerBuccaneers.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keySaints", 'content/playerSaints.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyFalcons", 'content/playerFalcons.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyPanthers", 'content/playerPanthers.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyNiners", 'content/playerNiners.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyRams", 'content/playerRams.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keyCardinals", 'content/playerCardinals.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        this.load.spritesheet("keySeahawks", 'content/playerSeahawks.png', {
            frameWidth: 20,
            frameHeight: 20
        });
        ...
        this.load.spritesheet('playerHit', 'content/playerHit.png', {
            frameWidth: 25,
            frameHeight: 20
        });
    ...
    create() {
        ...
        this.targetA.visible = false;
        this.targetD.visible = false;
        ...
        if (mobile) {
            ...
            this.dpadTop = this.add.sprite(105, 400, 'dpadTop').setInteractive({
                draggable: true
            });
        ...
        this.textScoreTeam1 = this.add.text(200, 5, scoreTeam1, {
            fontFamily: 'Arial',
            fontSize: 18,
            color: '#000000'
        });
        ...
        this.textScoreTeam2 = this.add.text(200, 35, scoreTeam2, {
            fontFamily: 'Arial',
            fontSize: 18,
            color: '#000000'
        });
        ...
        this.textYardline = this.add.text(10, 63, "Ball on the " + yardline, {
            fontFamily: 'Arial',
            fontSize: 14,
            color: '#ff0000'
        });
        ...
        this.textYardsToGo = this.add.text(105, 95, "1st Down", {
            fontFamily: 'Arial',
            fontSize: 24,
            color: '#ffffff'
        });
        ...
        this.stats = this.add.text(106, 280, "GAME STATS", {
            fontFamily: 'Arial',
            fontSize: 18,
            color: '#ffffff'
        });
        ...
        this.statsInterceptions = this.add.text(30, 310, "Interceptions", {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsInterceptions.setOrigin(0.0, 0.0);
        this.statsInterceptionsNum = this.add.text(180, 310, statsInterceptions, {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsInterceptionsNum.setOrigin(1.0, 0.0);
        this.statsPassYards = this.add.text(30, 335, "Pass Yards", {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsPassYards.setOrigin(0.0, 0.0);
        this.statsPassYardsNum = this.add.text(180, 335, statsPassYards, {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsPassYardsNum.setOrigin(1.0, 0.0);
        this.statsRushYards = this.add.text(30, 360, "Rush Yards", {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsRushYards.setOrigin(0.0, 0.0);
        this.statsRushYardsNum = this.add.text(180, 360, statsRushYards, {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsRushYardsNum.setOrigin(1.0, 0.0);
        this.statsCompletions = this.add.text(30, 385, "Completions", {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsCompletions.setOrigin(0.0, 0.0);
        this.statsCompletionsNum = this.add.text(180, 385, statsCompletions, {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsCompletionsNum.setOrigin(1.0, 0.0);
        this.statsTouchdowns = this.add.text(30, 410, "Touchdowns", {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsTouchdowns.setOrigin(0.0, 0.0);
        this.statsTouchdownsNum = this.add.text(180, 410, statsTouchdowns, {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsTouchdownsNum.setOrigin(1.0, 0.0);
        this.statsTotalYards = this.add.text(30, 435, "Total Yards", {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        this.statsTotalYards.setOrigin(0.0, 0.0);
        this.statsTotalYardsNum = this.add.text(180, 435, statsTotalYards, {
            fontFamily: 'Arial',
            fontSize: 12,
            color: '#ffffff'
        });
        ...
        if (time == 300) {
            this.textTime = this.add.text(200, 61, '5:00', {
                fontFamily: 'Arial',
                fontSize: 18,
                color: '#0000ff'
            });
        ...
        if (time == 600) {
            this.textTime = this.add.text(200, 61, '10:00', {
                fontFamily: 'Arial',
                fontSize: 18,
                color: '#0000ff'
            });
        ...
        if (time == 900) {
            this.textTime = this.add.text(200, 61, '15:00', {
                fontFamily: 'Arial',
                fontSize: 18,
                color: '#0000ff'
            });
        ...
        //TEAM 1 initialize
        this.qb = new QB(this, 320, 460, player1Key);
        this.qb.setData("startX", 320);
        this.qb.setData("startY", 1200);
        this.fb = new FB(this, 320, 420, player1Key);
        this.fb.setData("startX", 200);
        this.fb.setData("startY", 840);
        this.tb = new TB(this, 340, 460, player1Key);
        this.tb.setData("startX", 320);
        this.tb.setData("startY", 1320);
        this.wr1 = new WR1(this, 280, 420, player1Key);
        this.wr1.setData("startX", 150);
        this.wr1.setData("startY", 780);
        this.wr2 = new WR2(this, 360, 420, player1Key);
        this.wr2.setData("startX", 490);
        this.wr2.setData("startY", 780);
        this.wr3 = new WR3(this, 300, 420, player1Key);
        this.wr3.setData("startX", 440);
        this.wr3.setData("startY", 840);
        this.lt = new LT(this, 280, 400, player1Key);
        this.lt.setData("startX", 100);
        this.lt.setData("startY", 660);
        this.lg = new LG(this, 300, 400, player1Key);
        this.lg.setData("startX", 200);
        this.lg.setData("startY", 660);
        this.c = new C(this, 320, 400, player1Key);
        this.c.setData("startX", 320);
        this.c.setData("startY", 660);
        this.rg = new RG(this, 340, 400, player1Key);
        this.rg.setData("startX", 440);
        this.rg.setData("startY", 660);
        this.rt = new RT(this, 360, 400, player1Key);
        this.rt.setData("startX", 540);
        this.rt.setData("startY", 660);
        //TEAM 2 initialize
        this.db1 = new DB1(this, 260, 240, player2Key);
        this.db1.setData("startX", 50);
        this.db2 = new DB2(this, 380, 240, player2Key);
        this.db2.setData("startX", 590);
        this.ss = new SS(this, 280, 240, player2Key);
        this.ss.setData("startX", 100);
        this.fs = new FS(this, 360, 240, player2Key);
        this.fs.setData("startX", 540);
        this.lb1 = new LB1(this, 300, 240, player2Key);
        this.lb1.setData("startX", 150);
        this.lb2 = new LB2(this, 320, 180, player2Key);
        this.lb2.setData("startX", 320);
        this.lb2.setData("startY", 440);
        this.lb3 = new LB3(this, 340, 240, player2Key);
        this.lb3.setData("startX", 490);
        this.dl1 = new DL1(this, 280, 220, player2Key);
        this.dl1.setData("startX", 200);
        this.dl2 = new DL2(this, 360, 220, player2Key);
        this.dl2.setData("startX", 440);
        this.dl3 = new DL3(this, 300, 220, player2Key);
        this.dl3.setData("startX", 250);
        this.dl4 = new DL4(this, 340, 220, player2Key);
        this.dl4.setData("startX", 390);
    ...
    update() {
        ...
        if (this.qb.getData("hasBall")) {
            ballCarrier = this.qb;
        }
        if (this.tb.getData("hasBall")) {
            ballCarrier = this.tb;
        }
        if (this.wr1.getData("hasBall")) {
            ballCarrier = this.wr1;
        }
        if (this.wr2.getData("hasBall")) {
            ballCarrier = this.wr2;
        }
        if (this.wr3.getData("hasBall")) {
            ballCarrier = this.wr3;
        }
        if (this.lb2.getData("hasBall")) {
            ballCarrier = this.lb2;
        }
        if (this.db1.getData("hasBall")) {
            ballCarrier = this.db1;
        }
        if (this.db2.getData("hasBall")) {
            ballCarrier = this.db2;
        }
        if (this.ss.getData("hasBall")) {
            ballCarrier = this.ss;
        }
        if (this.fs.getData("hasBall")) {
            ballCarrier = this.fs;
        }

        if (offensiveTeam == 1) {
            if (difficulty == 2.4) {
                this.circle2.x = this.lb2.x;
                this.circle2.y = this.lb2.y;
                this.circle2.visible = true;
            }
            if (ballCarrier != null) {
                this.circle.x = ballCarrier.x;
                this.circle.y = ballCarrier.y;
            ...
            this.circle.x = this.qb.x;
            this.circle.y = this.qb.y;
            this.circle.visible = true;
        }
        ...
        if (kickOffKicked || kickOffStarted) {
            counterGmDropdown += 1;
            if (counterGmDropdown < 500 && counterGmDropdown > 0) {
                this.gmDropdown.setAlpha(counterGmDropdown / 100);
                this.gmDropdown.visible = true;
                if (this.gmDropdown.x < 0) {
                    this.gmDropdown.x += 1;
                }
            }
            if (counterGmDropdown > 500 && counterGmDropdown < 600) {
                this.gmDropdown.setAlpha(1 - counterGmDropdown / 600);
        ...
        if (kickOff && kickReturnTeam == 1) {
            if (ballSnapped) {
                if (!inPlay) {
                    ...
                    this.ball.y += 2;
                    if (this.ball.scaleX < 2 && this.ball.y < 930) {
                        ballScale += 0.01;
                        this.ball.setScale(ballScale)
                    };
                    if (this.ball.scaleX > 0.33 && this.ball.y > 930) {
                        ballScale -= 0.01;
                        this.ball.setScale(ballScale)
                    };
                    if (this.ball.y >= 1320) {
                ...
                if (ballCarrier != null && !tackled) {
                    if (this.keySpace.isDown && canSpin && !ballCarrier.getData("spinning")) {
                        ballCarrier.setData("spinning", true);
                        ballCarrier.y -= 5;
                    }
                    if (this.keySpace.isDown && !mobileSpin) {
                        canSpin = false;
                    } else {
                        canSpin = true;
                    }
                    if ((this.keyW.isDown || mobileBoost) && speedBoost > 0) {
                        ballCarrier.setData("speed", ballCarrier.getData("speedOriginal") + 0.6);
                        speedBoost -= 0.5;
                        this.speedBar.setScale(1, speedBoost / 100);
                    } else {
                        ballCarrier.setData("speed", ballCarrier.getData("speedOriginal"));
                    }
                    this.ball.x = ballCarrier.x;
                    this.ball.y = ballCarrier.y;
                    if (this.keyUp.isDown) {
                        ballCarrier.y -= ballCarrier.getData("speed");
                    }
                    if (this.keyDown.isDown) {
                        ballCarrier.y += ballCarrier.getData("speed");
                    }
                    if (this.keyLeft.isDown) {
                        ballCarrier.x -= ballCarrier.getData("speed");
                    ...
                    if (ballCarrier.y > 360) {
                        this.container.y = 1080 - ballCarrier.y - 720;
                    }
                    if (ballCarrier.y <= 360) {
                        this.container.y = 0;
                    }
                    if (ballCarrier.x < 25 || ballCarrier.x > 615) {
                        tackled = true;
                        this.justTackled();
                    }
                }
        ...
        if (kickOffStarted && kickReturnTeam == 2) {
            if (!ballSnapped) {
                ...
                //presnap...
                if ((this.keyW.isDown || mobileBoost) && speedBoost > 0) {
                    if (this.qb.getData("speed") < this.qb.getData("speedOriginal") + 0.6) {
                        this.qb.setData("speed", this.qb.getData("speed") + 0.1)
                    }
                    //this.qb.setData("speed",this.qb.getData("speedOriginal") + 0.6);
                    speedBoost -= 0.5;
                    this.speedBar.setScale(1, speedBoost / 100);
                } else {
                    if (this.qb.getData("speed") < this.qb.getData("speedOriginal")) {
                        this.qb.setData("speed", this.qb.getData("speed") + 0.01);
                    }
                    if (this.qb.getData("speed") > this.qb.getData("speedOriginal")) {
                        this.qb.setData("speed", this.qb.getData("speed") - 0.1);
                    }
                }
                if (this.keyUp.isDown && this.qb.y > yardlinePixel + 10) {
                    this.qb.y -= this.qb.getData("speed");
                }
                if (this.keyDown.isDown) {
                    this.qb.y += this.qb.getData("speed");
                }
                if (this.keyLeft.isDown) {
                    this.qb.x -= this.qb.getData("speed");
                    this.circle.rotation -= 0.1;
                }
                if (this.keyRight.isDown) {
                    this.qb.x += this.qb.getData("speed");
                ...
                //mobile controls
                if (mobileUp && this.qb.y > yardlinePixel + 10) {
                    this.qb.y -= this.qb.getData("speed");
                }
                if (mobileDown) {
                    this.qb.y += this.qb.getData("speed");
            ...
            if (ballSnapped) {
                if (!inPlay) {
                    if (!onsideKick) {
                        ...
                        this.container.y += 1.4;
                        this.ball.y -= 2;
                        if (this.ball.scaleX < 2 && this.ball.y > 450) {
                            ballScale += 0.01;
                            this.ball.setScale(ballScale)
                        };
                        if (this.ball.scaleX > 0.33 && this.ball.y < 450) {
                            ballScale -= 0.01;
                            this.ball.setScale(ballScale)
                        };
                        if (this.ball.y <= 120) {
                    ...
                    if (onsideKick) {
                        ...
                        if (this.ball.y >= 800) {
                            this.ball.x += 1.6;
                        } //if(this.ball.scaleX < 2 && this.ball.y > 450){ballScale += 0.01;this.ball.setScale(ballScale)};
                        if (this.ball.y < 800 && this.ball.y > 775) {
                            this.ball.x -= 1.0;
                        } //if(this.ball.scaleX < 2 && this.ball.y > 450){ballScale += 0.01;this.ball.setScale(ballScale)};
                        if (this.ball.y < 775 && this.ball.y > 700) {
                            this.ball.x += 0.5;
                        } //if(this.ball.scaleX < 2 && this.ball.y > 450){ballScale += 0.01;this.ball.setScale(ballScale)};
                        if (this.ball.y < 700) {
                            if (this.ball.x > this.ss.x) {
                                this.ball.x -= 0.2;
                            }
                            if (this.ball.x < this.ss.x) {
                                this.ball.x += 0.2;
                ...
                if (!tackled) {
                    ...
                    if ((this.keySpace.isDown || mobileBlast) && canBlast) {
                        this.qb.blast();
                        canBlast = false;
                    }
                    if (!this.keySpace.isDown && !mobileBlast) {
                        canBlast = true;
                    }
                    if (this.keyUp.isDown) {
                        this.qb.y -= this.qb.getData("speed");
                    ...
                    if (this.ball.y > 360 && this.ball.y > yardlinePixel) {
        ...
        if (!ballSnapped && playSelected && fieldGoal && offensiveTeam == 2) {
            ...
            if (this.keyUp.isDown && this.qb.y > yardlinePixel + 20) {
                this.qb.y -= this.qb.getData("speed");
            }
            if (this.keyDown.isDown) {
                this.qb.y += this.qb.getData("speed");
            ...
            //mobile controls
            if (mobileUp && this.qb.y > yardlinePixel + 20) {
                this.qb.y -= this.qb.getData("speed");
            }
            if (mobileDown) {
                this.qb.y += this.qb.getData("speed");
        ...
        if (!kickOff && !fieldGoal) {
                ...
                if (!fieldGoal) {
                    ...
                    if (ballSnapped) {
                        ...
                        if (ballCarrier != null && !tackled && ballCarrier.getData("hasBall")) {
                            ...
                            if (ballCarrier.y > 360 && ballCarrier.y < yardlinePixel) {
                                this.container.y = 1080 - ballCarrier.y - 720;
                            }
                            if (ballCarrier.y <= 360) {
                                this.container.y = 0;
            ...
            if (offensiveTeam == 2) {
                if (!ballSnapped) {
                    ...
                    if (this.keyUp.isDown && this.qb.y > yardlinePixel + 48) {
                        this.qb.y -= this.qb.getData("speed");
                    }
                    if (this.keyDown.isDown) {
                        this.qb.y += this.qb.getData("speed");
                    ...
                    //mobile controls
                    if (mobileUp && this.qb.y > yardlinePixel + 48) {
                        this.qb.y -= this.qb.getData("speed");
                    }
                    if (mobileDown) {
                        this.qb.y += this.qb.getData("speed");
                ...
                if (ballSnapped) {
                    if (!fieldGoal) {
                        ...
                        if (!inPlay && !shotgun && !ballPassed) {
                            if (ballCarrier == null) {
                                this.ball.x = this.lb2.x;
                                this.ball.y = this.lb2.y;
                            }
                        }
        ...
        if (goingFor2) {
            ...
            if (offensiveTeam == 1 && !safety2) {
                ...
                if (yardsToGo > (yardlinePixel - 120) / 12) {
                    if (down == 1) {
                        this.textYardsToGo.setText("1st & Goal");
                    }
                    if (down == 2) {
                        this.textYardsToGo.setText("2nd & Goal");
                    }
                    if (down == 3) {
                        this.textYardsToGo.setText("3rd & Goal");
                    }
                    if (down == 4) {
                        this.textYardsToGo.setText("4th & Goal");
                    }
                } else {
                    if (down == 1) {
                        this.textYardsToGo.setText("1st & " + yardsToGo);
                    }
                    if (down == 2) {
                        this.textYardsToGo.setText("2nd & " + yardsToGo);
                    }
                    if (down == 3) {
                        this.textYardsToGo.setText("3rd & " + yardsToGo);
                    }
                    if (down == 4) {
                        this.textYardsToGo.setText("4th & " + yardsToGo);
                    }
                }
    ...
    huddleUp() {
        ...
        //Team 1
        //primaryTargets:
        this.qb.setData("primaryTarget", false);
        this.tb.setData("primaryTarget", false);
        this.wr1.setData("primaryTarget", false);
        this.wr2.setData("primaryTarget", false);
        this.wr3.setData("primaryTarget", false);
        this.qb.huddle();
        this.fb.huddle();
        this.tb.huddle();
        this.wr1.huddle();
        ...
        this.rg.huddle();
        this.rt.huddle();
        this.qb.setPosition(320, huddleY + 30);
        this.fb.setPosition(320, huddleY + 10);
        this.tb.setPosition(340, huddleY + 10);
        this.wr1.setPosition(300, huddleY + 10);
        this.wr2.setPosition(360, huddleY + 10);
        this.wr3.setPosition(280, huddleY + 10);
        this.lt.setPosition(280, huddleY - 10);
        this.lg.setPosition(300, huddleY - 10);
        this.c.setPosition(320, huddleY - 10);
        this.rg.setPosition(340, huddleY - 10);
        this.rt.setPosition(360, huddleY - 10);
        ...
        //Team2
        //primaryTargets:
        this.lb2.setData("primaryTarget", false);
        this.ss.setData("primaryTarget", false);
        this.db1.setData("primaryTarget", false);
        this.db2.setData("primaryTarget", false);
        this.fs.setData("primaryTarget", false);
        this.db1.huddle();
        this.db2.huddle();
        this.ss.huddle();
        this.fs.huddle();
        ...
        this.dl3.huddle();
        this.dl4.huddle();
        this.db1.setPosition(320, huddleY2 - 10);
        this.db2.setPosition(300, huddleY2 - 10);
        this.ss.setPosition(340, huddleY2 - 10);
        this.fs.setPosition(280, huddleY2 - 10);
        this.lb1.setPosition(360, huddleY2 - 10);
        this.lb2.setPosition(320, huddleY2 - 30);
        this.lb3.setPosition(280, huddleY2 + 10);
        this.dl1.setPosition(300, huddleY2 + 10);
        this.dl2.setPosition(320, huddleY2 + 10);
        this.dl3.setPosition(340, huddleY2 + 10);
        this.dl4.setPosition(360, huddleY2 + 10);
    ...
    setTeam1Play() {
        ...
        if (team1Formation == "kickReturn") {
            this.qb.setPosition(320, 1200);
            this.fb.setPosition(200, 840);
            this.tb.setPosition(320, 1320);
            this.wr1.setPosition(150, 780);
            this.wr2.setPosition(490, 780);
            this.wr3.setPosition(440, 840);
            this.lt.setPosition(100, 660);
            this.lg.setPosition(200, 660);
            this.c.setPosition(320, 660);
            this.rg.setPosition(440, 660);
            this.rt.setPosition(540, 660);
            team1PlaySet = true;
        }
        if (team1Formation == "splitLt") {
            this.lt.setPosition(270, set);
            this.lg.setPosition(295, set);
            this.c.setPosition(320, set);
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set + 10);
            this.wr2.setPosition(245, set);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(280, set + 60);
            this.tb.setPosition(360, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "splitRt") {
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set + 10);
            this.wr2.setPosition(395, set);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(360, set + 60);
            this.tb.setPosition(280, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "iRt") {
            ...
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(395, set);
            this.wr3.setPosition(540, set + 10);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(320, set + 50);
            this.tb.setPosition(320, set + 75);
            team1PlaySet = true;
        }
        ...
        if (team1Formation == "shotgunTripsLt") {
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(200, set);
            this.wr3.setPosition(540, set + 10);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(160, set + 10);
            this.tb.setPosition(360, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "shotgunLt") { //fb in slot
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(190, set + 10);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(420, set + 20);
            this.tb.setPosition(280, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "shotgunRt") { //fb in slot
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(420, set + 20);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(190, set + 10);
            this.tb.setPosition(360, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "shotgunZback") { //fb in slot
            ...
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(420, set + 20);
            this.wr3.setPosition(360, set + 60);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(190, set + 10);
            this.tb.setPosition(540, set);
            team1PlaySet = true;
        }
        if (team1Formation == "bunchRt") {
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(460, set);
            this.wr3.setPosition(500, set + 10);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(420, set + 10);
            this.tb.setPosition(280, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "bunchLt") {
            ...
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.wr1.setPosition(140, set + 10);
            this.wr2.setPosition(180, set);
            this.wr3.setPosition(540, set + 10);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(220, set + 10);
            this.tb.setPosition(360, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "aceRt") { //fb in slot
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(450, set + 10);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(190, set + 10);
            this.tb.setPosition(320, set + 60);
            team1PlaySet = true;
        }
        if (team1Formation == "aceRtSwitch") { //fb in slot
            ...
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(320, set + 60);
            this.tb.setPosition(210, set + 20);
            team1PlaySet = true;
        }
        if (team1Formation == "emptyRt") { //fb in slot
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(470, set + 20);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(240, set + 20);
            this.tb.setPosition(400, set + 20);
            team1PlaySet = true;
        }
        if (team1Formation == "emptyLtInvert") { //tb Y switch spots
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(400, set + 20);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(210, set + 20);
            this.tb.setPosition(160, set + 20);
            team1PlaySet = true;
        }
        if (team1Formation == "emptyLt") { //fb in slot
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(170, set + 20);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(240, set + 20);
            this.tb.setPosition(400, set + 20);
        ...
        if (team1Formation == "emptyLtFlip") { //fb flip w/y tb flip w/z
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set);
            this.wr2.setPosition(240, set + 20);
            this.wr3.setPosition(400, set);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(170, set + 20);
            this.tb.setPosition(540, set + 20);
            team1PlaySet = true;
        }
        //redZone...
        if (team1Formation == "splitOptionAngle") { //Z reciever in backfield on left
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(100, set + 10);
            this.wr2.setPosition(450, set);
            this.wr3.setPosition(280, set + 60);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(360, set + 60);
            this.tb.setPosition(540, set);
            team1PlaySet = true;
        ...
        if (team1Formation == "aceTbSwing") { //Y reciever in backfield on left
            ...
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.wr1.setPosition(450, set + 10);
            this.wr2.setPosition(320, set + 60);
            this.wr3.setPosition(540, set);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(100, set + 10);
            this.tb.setPosition(160, set);
            team1PlaySet = true;
        }
        if (team1Formation == "bunchLtBubble") {
            ...
            this.rt.setPosition(370, set);
            this.wr1.setPosition(140, set + 10);
            this.wr2.setPosition(220, set + 10);
            this.wr3.setPosition(540, set + 10);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(180, set);
            this.tb.setPosition(320, set + 60);
            team1PlaySet = true;
        }
        //Special
        if (team1Formation == "victoryRt") { //fb in slot
            ...
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.wr1.setPosition(200, set);
            this.wr2.setPosition(395, set + 10);
            this.wr3.setPosition(420, set);
            this.qb.setPosition(320, set + 20);
            this.fb.setPosition(250, set + 10);
            this.tb.setPosition(320, set + 60);
            team1PlaySet = true;
        }
        ...
        if (team1Formation == "fieldGoal") { //fb in slot
            ...
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.wr1.setPosition(220, set + 20);
            this.wr2.setPosition(395, set);
            this.wr3.setPosition(420, set + 20);
            this.qb.setPosition(320, set + 72);
            this.fb.setPosition(245, set);
            this.tb.setPosition(248, set + 144);
            team1PlaySet = true;
        }
        ...
        if (passPlay && offensiveTeam == 1) {
            this.targetA.visible = true;
            this.targetS.visible = true;
            this.targetD.visible = true;
            this.targetA.x = this.wr1.getData("startX") + targetLocation[0][0];
            this.targetA.y = this.wr1.getData("startY") + targetLocation[0][1];
            this.targetS.x = this.wr2.getData("startX") + targetLocation[1][0];
            this.targetS.y = this.wr2.getData("startY") + targetLocation[1][1];
            this.targetD.x = this.wr3.getData("startX") + targetLocation[2][0];
            this.targetD.y = this.wr3.getData("startY") + targetLocation[2][1];
        } else {
            this.targetA.visible = false;
            this.targetS.visible = false;
            this.targetD.visible = false;
        ...
        if (team1Formation == "kickOff") {
            this.lt.setPosition(220, set);
            this.lg.setPosition(170, set);
            this.rg.setPosition(470, set);
            this.rt.setPosition(520, set);
            this.c.setPosition(420, set);
            this.qb.setPosition(370, set + 10);
            this.fb.setPosition(270, set);
            this.wr1.setPosition(50, set);
            this.tb.setPosition(320, set + 84);
            this.wr2.setPosition(120, set);
            this.wr3.setPosition(570, set);
            team1PlaySet = true;
        }
        //KickOff Onside
        if (team1Formation == "kickOffOnside") {
            this.lt.setPosition(350, set);
            this.lg.setPosition(380, set);
            this.rg.setPosition(410, set);
            this.rt.setPosition(440, set);
            this.c.setPosition(470, set);
            this.qb.setPosition(500, set + 10);
            this.fb.setPosition(530, set);
            this.wr1.setPosition(560, set);
            this.tb.setPosition(320, set + 84);
            this.wr2.setPosition(590, set);
            this.wr3.setPosition(250, set);
            team1PlaySet = true;
        }
        //Defense
        if (team1Formation == "43") {
            this.lt.setPosition(265, set);
            this.lg.setPosition(295, set);
            this.rg.setPosition(345, set);
            this.rt.setPosition(375, set);
            this.c.setPosition(210, set + 50);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(450, set + 50);
            this.wr1.setPosition(50, set + 120);
            this.tb.setPosition(180, set + 84);
            this.wr2.setPosition(320, set + 140);
            this.wr3.setPosition(590, set + 120);
            team1PlaySet = true;
        }
        if (team1Formation == "34") {
            this.lt.setPosition(270, set);
            this.lg.setPosition(320, set);
            this.rg.setPosition(370, set);
            this.rt.setPosition(460, set);
            this.c.setPosition(200, set);
            this.qb.setPosition(280, set + 60);
            this.fb.setPosition(360, set + 50);
            this.wr1.setPosition(50, set + 120);
            this.tb.setPosition(180, set + 84);
            this.wr2.setPosition(320, set + 140);
            this.wr3.setPosition(590, set + 120);
        ...
        if (team1Formation == "bear") {
            this.lt.setPosition(295, set);
            this.lg.setPosition(320, set);
            this.rg.setPosition(345, set);
            this.rt.setPosition(400, set);
            this.c.setPosition(260, set);
            this.qb.setPosition(280, set + 60);
            this.fb.setPosition(360, set + 50);
            this.wr1.setPosition(50, set + 120);
            this.tb.setPosition(180, set + 84);
        ...
        if (team1Formation == "44Stack") {
            this.lt.setPosition(280, set);
            this.lg.setPosition(300, set);
            this.rg.setPosition(340, set);
            this.rt.setPosition(380, set);
            this.c.setPosition(300, set + 50);
            this.qb.setPosition(340, set + 60);
            this.fb.setPosition(420, set + 50);
            this.wr1.setPosition(50, set + 120);
            this.tb.setPosition(240, set + 50);
            this.wr2.setPosition(320, set + 140);
            this.wr3.setPosition(590, set + 120);
            team1PlaySet = true;
        }
        if (team1Formation == "43Over") {
            this.lt.setPosition(265, set);
            this.lg.setPosition(310, set);
            this.rg.setPosition(350, set);
            this.rt.setPosition(375, set);
            this.c.setPosition(210, set + 50);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(450, set + 50);
        ...
        if (team1Formation == "62") {
            ...
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.c.setPosition(220, set);
            this.qb.setPosition(320, set + 60);
            this.fb.setPosition(420, set);
            this.wr1.setPosition(50, set + 120);
            this.tb.setPosition(180, set + 84);
            this.wr2.setPosition(320, set + 140);
            this.wr3.setPosition(590, set + 120);
        ...
        if (team1Play == "cov2") {
            this.wr1.setPosition(50, set + 48);
            this.tb.setPosition(160, set + 140);
            this.wr2.setPosition(480, set + 140);
            this.wr3.setPosition(590, set + 48);
        }
        if (team1Play == "cov4") {
            this.tb.setPosition(220, set + 140);
            this.wr2.setPosition(420, set + 140);
        }
        if (team1Play == "crash") {
            this.wr1.setPosition(50, set + 48);
            this.tb.setPosition(160, set + 140);
        ...
        if (team1Formation == "fgBlock") { //fieldgoal block
            ...
            this.rg.setPosition(345, set);
            this.rt.setPosition(370, set);
            this.wr1.setPosition(220, set);
            this.wr2.setPosition(395, set);
            this.wr3.setPosition(420, set);
            this.qb.setPosition(320, set + 72);
            this.fb.setPosition(245, set);
            this.tb.setPosition(195, set);
            team1PlaySet = true;
        }
    } //end setTeam1Play()
    ...
    setTeam2Play() {
        ...
        if (team2Formation == "kickOff") {
            this.db1.setPosition(50, 540);
            this.db2.setPosition(590, 540);
            this.ss.setPosition(100, 540);
            this.fs.setPosition(540, 540);
            this.lb1.setPosition(150, 540);
            this.lb2.setPosition(320, 440);
            this.lb3.setPosition(200, 540);
            this.dl1.setPosition(440, 540);
            this.dl2.setPosition(250, 540);
            this.dl3.setPosition(390, 540);
            this.dl4.setPosition(490, 540);
            team2PlaySet = true;
        }
        if (team2Formation == "kickReturn") {
            this.db1.setPosition(50, set2 - 110);
            this.db2.setPosition(590, set2 - 110);
            this.ss.setPosition(320, 121);
            this.fs.setPosition(540, set2 - 210);
            this.lb1.setPosition(150, set2 - 210);
            this.lb2.setPosition(320, set2 - 110);
            this.lb3.setPosition(200, set2 - 110);
            this.dl1.setPosition(440, set2 - 110);
            this.dl2.setPosition(250, set2 - 310);
            this.dl3.setPosition(390, set2 - 310);
            this.dl4.setPosition(490, set2 - 110);
            team2PlaySet = true;
        }
        if (team2Formation == "kickReturnOnside") {
            this.db1.setPosition(250, set2 - 110);
            this.db2.setPosition(300, set2 - 110);
            this.ss.setPosition(480, set2 - 220);
            this.fs.setPosition(360, set2 - 110);
            this.lb1.setPosition(390, set2 - 110);
            this.lb2.setPosition(420, set2 - 110);
            this.lb3.setPosition(450, set2 - 110);
            this.dl1.setPosition(480, set2 - 110);
            this.dl2.setPosition(510, set2 - 110);
            this.dl3.setPosition(540, set2 - 110);
            this.dl4.setPosition(570, set2 - 110);
            team2PlaySet = true;
        }
        if (team2Formation == "43") {
            this.db1.setPosition(50, yardlinePixel - 120);
            this.db2.setPosition(590, yardlinePixel - 120);
            this.ss.setPosition(160, yardlinePixel - 60);
            this.fs.setPosition(320, yardlinePixel - 168);
            this.lb1.setPosition(240, yardlinePixel - 60);
            this.lb2.setPosition(320, yardlinePixel - 60);
            this.lb3.setPosition(420, yardlinePixel - 60);
            this.dl1.setPosition(260, set2);
            this.dl2.setPosition(300, set2);
            this.dl3.setPosition(350, set2);
            this.dl4.setPosition(380, set2);
            team2PlaySet = true;
        }
        if (team2Formation == "34") {
            ...
            this.ss.setPosition(160, yardlinePixel - 60);
            this.fs.setPosition(320, yardlinePixel - 168);
            this.lb1.setPosition(240, set2);
            this.lb2.setPosition(290, yardlinePixel - 60);
            this.lb3.setPosition(350, yardlinePixel - 60);
            this.dl1.setPosition(285, set2);
            this.dl2.setPosition(320, set2);
            this.dl3.setPosition(355, set2);
            this.dl4.setPosition(400, set2);
            team2PlaySet = true;
        }
        if (team2Formation == "bear") {
            ...
            this.fs.setPosition(320, yardlinePixel - 168);
            this.lb1.setPosition(240, set2);
            this.lb2.setPosition(290, yardlinePixel - 40);
            this.lb3.setPosition(350, yardlinePixel - 50);
            this.dl1.setPosition(300, set2);
            this.dl2.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
            this.dl4.setPosition(400, set2);
            team2PlaySet = true;
        }
        if (team2Formation == "fgBlock") {
            this.db1.setPosition(260, set2);
            this.db2.setPosition(420, set2);
            this.ss.setPosition(240, set2);
            this.fs.setPosition(320, yardlinePixel - 60);
            this.lb1.setPosition(280, set2);
            this.lb2.setPosition(380, set2);
            this.lb3.setPosition(400, set2);
            this.dl1.setPosition(300, set2);
            this.dl2.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
            this.dl4.setPosition(360, set2);
            team2PlaySet = true;
        }
        if (offensiveTeam == 1) {
            if (team2Secondary == 1) {
            ...
            if (team2Secondary == 2) {
                this.db1.setPosition(45, yardlinePixel - 60);
                this.db2.setPosition(595, yardlinePixel - 60);
                this.ss.setPosition(200, yardlinePixel - 144);
                this.fs.setPosition(440, yardlinePixel - 144);
            }
            if (team2Secondary == 3) {
                this.db1.setPosition(50, yardlinePixel - 120);
                this.db2.setPosition(590, yardlinePixel - 120);
        ...
        if (team2Formation == "splitLt") {
            this.db1.setPosition(60, set2);
            this.db2.setPosition(580, set2 - 10);
            this.fs.setPosition(380, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(350, yardlinePixel - 50);
            this.ss.setPosition(290, yardlinePixel - 50);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
            this.dl4.setPosition(360, set2);
            team2PlaySet = true;
        }
        if (team2Formation == "splitRt") {
            this.db1.setPosition(60, set2);
            this.db2.setPosition(580, set2 - 10);
            this.fs.setPosition(260, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(290, yardlinePixel - 50);
            this.ss.setPosition(350, yardlinePixel - 50);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
        ...
        if (team2Formation == "iLt") {
            ...
            this.fs.setPosition(380, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(320, yardlinePixel - 54);
            this.ss.setPosition(320, yardlinePixel - 84);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
        ...
        if (team2Formation == "bunchLt") {
            this.db1.setPosition(60, set2);
            this.db2.setPosition(460, set2 - 15);
            this.fs.setPosition(430, set2);
            this.lb2.setPosition(320, yardlinePixel - 50);
            this.lb3.setPosition(400, set2 - 15);
            this.ss.setPosition(290, yardlinePixel - 50);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
        ...
        if (team2Formation == "bunchRt") {
            this.db1.setPosition(180, set2 - 15);
            this.db2.setPosition(580, set2 - 10);
            this.fs.setPosition(210, set2);
            this.lb2.setPosition(320, yardlinePixel - 50);
            this.lb3.setPosition(260, set2 - 15);
            this.ss.setPosition(350, yardlinePixel - 50);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
        ...
        if (team2Formation == "splitLtX") {
            this.db1.setPosition(290, yardlinePixel - 50);
            this.db2.setPosition(580, set2 - 10);
            this.fs.setPosition(380, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(350, yardlinePixel - 50);
            this.ss.setPosition(60, set2);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
        ...
        if (team2Formation == "splitRtX") {
            this.db1.setPosition(60, set2);
            this.db2.setPosition(350, yardlinePixel - 50);
            this.fs.setPosition(260, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(290, yardlinePixel - 50);
            this.ss.setPosition(580, set2 - 10);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
        ...
        if (team2Formation == "stackRtX") {
            this.db1.setPosition(80, set2);
            this.db2.setPosition(350, yardlinePixel - 50);
            this.fs.setPosition(260, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(290, yardlinePixel - 50);
            this.ss.setPosition(80, set2 - 30);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
        ...
        if (team2Formation == "stackLtX") {
            this.db1.setPosition(580, set2);
            this.db2.setPosition(350, yardlinePixel - 50);
            this.fs.setPosition(260, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(290, yardlinePixel - 50);
            this.ss.setPosition(580, set2 - 30);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
        ...
        if (team2Formation == "aceStackLtX") {
            this.db1.setPosition(580, set2);
            this.db2.setPosition(160, yardlinePixel - 20);
            this.fs.setPosition(70, set2);
            this.lb2.setPosition(320, set2 - 20);
            this.lb3.setPosition(320, yardlinePixel - 60);
            this.ss.setPosition(580, set2 - 30);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
        ...
        if (team2Formation == "fieldGoal") {
            this.db1.setPosition(250, set2 - 20);
            this.db2.setPosition(390, set2 - 20);
            this.fs.setPosition(380, set2);
            this.lb2.setPosition(330, set2 - 120);
            this.lb3.setPosition(260, set2);
            this.ss.setPosition(310, yardlinePixel - 84);
            this.dl1.setPosition(280, set2);
            this.dl2.setPosition(300, set2);
            this.lb1.setPosition(320, set2);
            this.dl3.setPosition(340, set2);
